...
#creating an array that only has words, removing spaces, commas etc.
...
#using nltk frequency distribution function to get the most commom word in the array without the stop words.
